    ...
    <section className="relative isolate overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 grid lg:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <h1 className="text-4xl/tight md:text-5xl font-semibold">
            Saznaj zašto tvoj marketing ne donosi novac i kako da to promeniš
            POTPUNO BESPLATNO
          </h1>
          <p className="mt-4 text-muted-foreground max-w-prose">
            Dobijaš personalizovanu marketing analizu i jasan plan kako da tvoj
            biznis dođe do više prodaja, kreirano od fullstack marketing tima
            koji garantuje rezultate.
          </p>
